...
class KucoinAPIException(Exception):
    ...
    def __str__(self):
        return f'KucoinAPIException {self.code}: {self.message}'
...
class KucoinRequestException(Exception):
    ...
    def __str__(self):
        return f'KucoinRequestException: {self.message}'


class OrderParameterValidationException(Exception):
    def __init__(self, message):
        self.message = message

    def __str__(self):
        return f'OrderParameterValidationException: {self.message}'
